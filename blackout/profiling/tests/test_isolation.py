...
Description: The rule that keeps the profiling harness out of the game.
             ...
             reverse. Nothing under blackout/ outside profiling/ may
             ...
             The precedent is systems/interface/statefeed/tests/test_client_constants.py,
...
# The game directory, three levels up from
# profiling/tests/test_isolation.py.
_HERE = os.path.dirname(os.path.abspath(__file__))
_GAME_DIR = os.path.dirname(os.path.dirname(_HERE))
...
def _game_modules():
    ...
    Creation date: 09/03/2026
    """
    harness_root = os.path.join(_GAME_DIR, "profiling")
...
def _imported_names(path) -> list:
    ...
    Methodology:
        ast rather than a regex, so that the word "profiling" appearing
...
class TestProfilingIsNotImportedByTheGame(unittest.TestCase):
    ...
    def test_no_game_module_imports_the_harness(self):
        ...
        self.assertEqual(offenders, [],
                         ...
                         "(systems/core/tick/engine.py's register_phase_hook is "
