...
exact words systems/core/tick/tests/test_query_cost.py uses about the O(N*M) walk it
...
class ProfilingWorld:
    ...
    def build(self) -> "ProfilingWorld":
        ...
        Notes/References:
            ...
            systems/gameplay/combat/auras/tests/test_aura_targeting.py for why the
