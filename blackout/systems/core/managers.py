...
def register_manager(bootstrap_fn):
    ...
    Notes/References:
        ...
        @register_tickable in systems/gameplay/combat/tickable.py.
...
def get_singleton_script(key, script_cls):
    ...
    Notes/References:
        Written after systems/gameplay/combat/tick_engine.py moved to
        systems/core/tick/engine.py and the persisted engine row kept pointing at
