...
def register_phase_hook(phase: str, hook) -> None:
    ...
    systems/interface/statefeed/buffer.py, which uses START and FEED to bracket its
...
class BlackoutTickEngine(DefaultScript):
    ...
    def _registry(self) -> dict:
        ...
        and systems/gameplay/combat/tests/test_tickable.py fails if a subclass is
        missing from it.
        """
    ...
    def current_tick(self) -> int:
        ...
        absolute time instead (systems/gameplay/spawning/respawn.py explains why).
        """
