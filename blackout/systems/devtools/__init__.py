...
Description: Moderator tooling -- the effects a superuser or Admin may apply
             ...
             The package splits the way systems/gameplay/quests/ does, and for the same
             reason:

               constants.py  the literals: the god-mode attribute name, the
                             action vocabulary, the bounds, the message
                             templates. Imports systems/interface/ui/colors.py only.
               ...
               (menu)        systems/interface/menus/dev_egg_menu.py -- presentation
