...
Run from blackout/:
    ../evenv/Scripts/evennia.exe test --settings settings.py systems.gameplay.ai
...
from systems.gameplay.ai.behaviors import aggressive_melee
...
class TestControllerSeam(EvenniaTest):
    ...
    def test_an_unknown_behavior_key_is_logged_and_survives(self):
        ...
        with mock.patch("systems.gameplay.combat.combat.logger.log_err") as mocked_log:
            handler._consult_controller()
    ...
    def test_a_raising_behavior_is_caught_and_logged(self):
        ...
        with mock.patch(
            "systems.gameplay.combat.combat.get_behavior", return_value=_explode
        ):
            with mock.patch("systems.gameplay.combat.combat.logger.log_err") as mocked_log:
...
class TestRetaliationOverTicks(EvenniaTest):
    ...
    def _run_ticks(self, count):
        ...
        with mock.patch(
            "systems.gameplay.combat.combat.resolve_action", return_value=always_hits
        ):
