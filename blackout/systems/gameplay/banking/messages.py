...
Description: Player-facing wording for bank transfers — the presentation half
             of systems/gameplay/banking/handler.py.
...
banking menu in systems/interface/menus/banking_menu.py. Rendering it in both would put
...
def format_transfer(result, verb: str) -> str:
    ...
    Entry:
        result is a systems.gameplay.banking.handler.TransferResult.
