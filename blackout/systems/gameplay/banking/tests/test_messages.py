...
Description: The player-facing wording in systems/gameplay/banking/messages.py.

Run from blackout/:
    ../evenv/Scripts/evennia.exe test --settings settings.py systems.gameplay.banking
"""

from evennia.utils.test_resources import EvenniaTest, EvenniaTestCase

from systems.gameplay.banking import messages
from systems.gameplay.banking.handler import VAULT_FULL_ERROR, TransferResult
