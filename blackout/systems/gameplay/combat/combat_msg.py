...
# string assembly.
from systems.interface.ui.meters import build_hp_meter  # noqa: E402
...
def format_drops(victim, drops: list) -> str:
    ...
    Notes/References:
        ...
        reaches into ITEM_DB -- systems/gameplay/loot/drops.py already has the ItemDef
...
def format_hp_status(label: str, current_hp: int, max_hp: int) -> str:
    ...
    Methodology:
        Delegates the bar itself to systems.interface.ui.meters.build_hp_meter, the same
    ...
    Notes/References:
        systems/interface/ui/meters.py for the gradient and the width constant.
