...
--------------------------------------------
This is NOT part of the 0.6s tick rhythm in systems/core/tick/engine.py -- regen is a
...
``systems/gameplay/spawning/respawn.py``'s ``db.respawn_queue``) rather than an ndb
