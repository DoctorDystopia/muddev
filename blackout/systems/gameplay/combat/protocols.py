...
class SkillSource(Protocol):
    ...
    systems/gameplay/progression/skills/handler.SkillHandler for characters and by
    systems/gameplay/progression/skills/stat_block.StatBlockSkills for NPCs. Adding a
