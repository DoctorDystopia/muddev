...
Shape is deliberately identical to systems/gameplay/combat/auras/registry.py, which is
itself identical to systems/gameplay/progression/skills/registry.py. Same idiom, third
noun.
"""
