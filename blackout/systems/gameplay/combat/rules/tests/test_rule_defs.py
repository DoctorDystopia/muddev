...
from systems.gameplay.combat.rules.modifiers import apply_to_level
...
from systems.gameplay.combat.rules.rule_defs.glass_cannon_amulet import (
    GLASS_CANNON_BONUS_PER_STEP,
    GLASS_CANNON_BRAWN_PER_STEP,
    GlassCannonAmuletRules,
)
from systems.gameplay.combat.rules.rule_defs.malfunctioning_gizmo import (
...
class TestGlassCannonAmulet(unittest.TestCase):
    ...
    def test_the_bonus_is_scaled_by_the_augmentation_stage(self):
        ...
        from systems.gameplay.combat.rules.modifiers import ModifierBag
    ...
    def test_the_bonus_raises_the_damage_ceiling(self):
        ...
        without = _context(
            ScriptedRandom(randints=[999], randoms=[_ALWAYS_HITS]),
            attacker_levels=wearing)
