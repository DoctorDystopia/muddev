...
This is the point of systems/gameplay/combat/protocols.py. The contracts themselves are
...
from systems.gameplay.combat.protocols import Combatant, SkillSource, XpEarner
