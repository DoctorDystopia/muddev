...
Description: One skill, described in full -- as the text sheet a telnet player
             ...
             systems/interface/menus/skills_menu.py, which meant the only way to see a
             ...
             both outputs walk it, the arrangement systems/interface/statefeed/quests.py
             ...
             than anything else in systems/gameplay/progression/skills/ carries. The
...
def _recipe_rows(skill_key: str) -> list:
    ...
    Notes/References:
        Moved here from systems/interface/menus/skills_menu.py on 08/28/2026 unchanged.
...
def _aura_rows(skill_key: str) -> list:
    ...
    Creation date: 08/05/2026
    """
    from systems.gameplay.combat.auras.registry import get_auras_for_skill
...
def skill_detail(character: object, skill_key: str) -> dict:
    ...
    Notes/References:
        Consumed by systems/interface/statefeed/skills.py. Every value must survive
        json.dumps -- see systems/interface/statefeed/payloads.py.
