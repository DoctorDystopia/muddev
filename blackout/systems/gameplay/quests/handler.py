...
Description: QuestHandler -- one character's progress through the quests
             declared in systems/gameplay/quests/content/.
...
the import ring that split closes, and systems/gameplay/progression/skills/ for the
...
from systems.gameplay.quests.quests import normalize_target
...
def _publishes(method):
    ...
    Methodology:
        ...
        The import is inside the wrapper. systems.interface.statefeed.events reaches the
    ...
    Notes/References:
        ...
        through this class's public read API by systems/interface/statefeed/quests.py.
