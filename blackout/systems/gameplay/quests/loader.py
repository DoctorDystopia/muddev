...
import systems.gameplay.quests.content as content_package
...
class QuestRegistry:
    ...
    Purpose: The single catalog of every quest that exists in the game,
             discovered by walking systems/gameplay/quests/content/.
    ...
    Methodology:
        ...
        systems/gameplay/progression/skills/registry.py: adding a quest means adding
    ...
    Notes/References:
        ...
        systems/gameplay/quests/quests.py -- see the note at the head of that file.
