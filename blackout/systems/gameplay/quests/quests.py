...
This module must NOT import systems.gameplay.quests.loader. The loader builds its
        ...
        for target_key, requirement in targets.items():
            ...
            if action not in constants.QUEST_ACTIONS:
                raise ValueError(
                    ...
                    f"See systems/gameplay/quests/global_quest_actions.md."
                )
...
class QuestBlueprint:
    ...
    Notes/References:
        Discovered by systems/gameplay/quests/loader.py through the module-level QUESTS
