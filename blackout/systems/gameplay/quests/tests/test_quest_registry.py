...
from systems.gameplay.quests.loader import GLOBAL_QUEST_REGISTRY, QuestRegistry
...
class RegistryLoadTests(unittest.TestCase):
    ...
    def test_no_content_module_failed_to_load(self):
        ...
        systems/gameplay/quests/quests.py used to import the loader at module scope.
...
class RegistryDuplicateTests(unittest.TestCase):
    ...
    def test_duplicate_key_is_recorded_as_a_load_error(self):
        ...
        with unittest.mock.patch(
            "systems.gameplay.quests.loader.importlib.import_module",
            return_value=module,
        ):
            registry._load_module("systems.gameplay.quests.content.fake")
