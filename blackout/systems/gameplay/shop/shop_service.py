...
def _is_sellable(obj) -> bool:
    ...
    Notes/References:
        systems/interface/statefeed/tests/test_inventory.py asserts the payload's Sell
...
def _publish_inventory(caller) -> None:
    ...
    Notes/References:
        systems/gameplay/crafting/crafting_service.py _publish_inventory documents the
