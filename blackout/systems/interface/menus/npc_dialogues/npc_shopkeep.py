...
from systems.interface.menus.base_menu import back_option, cancel_option, parse_quantity
...
from systems.interface.menus.dialogue import resolve_farewell
...
from systems.gameplay.shop import messages as shop_messages
from systems.gameplay.shop.shop_service import (
    get_buy_items,
    get_sell_items,
    execute_buy,
    execute_sell,
...
def _report_trade(caller, result, verb, count):
    ...
    The sentence itself comes from systems/gameplay/shop/messages.py, which is shared
...
def _parse_sell_request(caller, raw_string, **kwargs):
    ...
    Notes/References:
        systems/gameplay/shop/shop_service.perform_sell does the parsing, the sale and
