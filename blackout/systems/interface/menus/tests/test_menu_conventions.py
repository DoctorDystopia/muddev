...
MENU_MODULE_PATHS = (
    "systems.interface.menus.banking_menu",
    "systems.interface.menus.combat_options_menu",
    "systems.interface.menus.crafting_menu",
...
class TestClosingText(_LiveMenuTest):
    ...
    def test_a_module_closing_text_is_picked_up(self):
        closing = base_menu._module_closing_text("systems.interface.menus.banking_menu")

        self.assertEqual("Closing banking menu.", closing)

    def test_an_explicit_close_text_wins_over_the_module(self):
        menu = self._open("systems.interface.menus.equipment_menu", close_text="Bespoke.")
    ...
    def test_closing_text_is_spoken_once_on_quit(self):
        menu = self._open("systems.interface.menus.equipment_menu")
    ...
    def test_a_callable_closing_text_is_given_caller_and_menu(self):
        ...
        menu = self._open("systems.interface.menus.equipment_menu", close_text=_closing)
        menu.close_menu()
