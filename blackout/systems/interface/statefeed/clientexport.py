...
_CHANNEL_EXPORTS: tuple = (
    ...
    ("CH_ROOM_PLAYERS_DELTA", const.CHANNEL_ROOM_PLAYERS_DELTA),
...
_MESSAGE_TYPE_EXPORTS: tuple = (
    ...
    ("MSG_MENU", const.MESSAGE_TYPE_MENU),
...
# The game dir (blackout/), three levels up from systems/interface/statefeed/clientexport.py.
