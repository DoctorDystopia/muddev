...
def _visible_rooms(room) -> list:
    ...
    Methodology:
        ...
        The lookup itself is MEMOISED by systems/interface/statefeed/neighbourhood.py,
        ...
        systems.gameplay.combat.auras.targeting, which reaches the xyzgrid contrib's
...
def _read_levels(skills) -> dict:
    ...
    Methodology:
        ...
        char_summary's job, built by systems/interface/summary/ from the same handler
...
def emit_swing(context, result, hp_after: int, max_hp: int,
    ...
    Notes/References:
        systems/gameplay/combat/combat.py:417 _land_hit documents why the
...
def emit_summary(observer, force: bool = False) -> int:
    ...
    Notes/References:
        Panel data is built by systems/interface/summary/service.py, which is also what
...
def emit_skills(observer, force: bool = False) -> int:
    ...
    Notes/References:
        The payload is built by systems/interface/statefeed/skills.py from the same
...
def emit_quests(observer, force: bool = False) -> int:
    ...
    Methodology:
        ...
        systems.interface.statefeed.quests is imported inside the routine. It reaches the
        quest loader, which imports every module under systems/gameplay/quests/content/;
    ...
    Notes/References:
        The payload is built by systems/interface/statefeed/quests.py, entirely through
...
def emit_inventory(observer, force: bool = False, ignore=None) -> int:
    ...
    Methodology:
        ...
        systems.interface.statefeed.inventory is imported inside the routine. It reaches
