...
class _Payload:
    ...
    def to_dict(self) -> dict:
        ...
        Methodology:
            ...
            Measured with profiling (scripts/profile_pipeline.py
            --layer statefeed):
...
class CharSummaryPayload(_Payload):
    ...
    file under systems/interface/summary/panel_defs/, and a dataclass field per panel
...
class CombatPayload(_Payload):
    ...
    Fields mirror ActionResult (systems/gameplay/combat/rules/context.py) so the feed
