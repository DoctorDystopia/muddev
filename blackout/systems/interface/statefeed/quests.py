...
Description: Turn a character's quest log into the plain values
             ...
             systems.interface.summary is: reaching the quest loader pulls in every
             module under systems/gameplay/quests/content/, and events.py is imported by
...
def build_payload(observer) -> CharQuestsPayload:
    ...
    Notes/References:
        Sent on CHANNEL_CHAR_QUESTS. See systems/interface/statefeed/constants.py.
