...
Run from blackout/:
    ../evenv/Scripts/evennia.exe test --settings settings.py \
        systems.interface.statefeed.tests.test_interaction
"""
...
from systems.interface.statefeed import events, serializers
...
# The game dir (blackout/), five levels up from this file, and the repo root
...
class TestEntityRadius(EvenniaTest):
    ...
    owns it and is covered by systems/gameplay/combat/auras/tests/test_aura_targeting.
