...
Description: Cases for the char_quests channel.
             ...
             THE SHAPE. `systems/interface/statefeed/quests.py` turns a quest log into
...
from systems.gameplay.quests.tests.stubs import FakeCharacter, FakeRegistry
from systems.interface.statefeed import quests as quest_feed
...
_REGISTRY_PATH = "systems.gameplay.quests.handler.GLOBAL_QUEST_REGISTRY"
...
_LOADER_PATH = "systems.gameplay.quests.loader.GLOBAL_QUEST_REGISTRY"
